...
**🇺🇸 Leia em:** [English](README.md) · [Español](README.es.md) · [简体中文](README.zh-CN.md)
...
1. **Instale o APK** — copie `adb-notify_debug.apk` para o `/sdcard/` e abra no
...
**Flags comuns:** `--help`, `--verbose`, `--json`, `--lang pt|en`,
